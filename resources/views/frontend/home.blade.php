...
<body class="index-page">
 ...
 <header id="header" class="header" style="position: fixed; top: 0; left: 0; width: 100%; z-index: 1050; background-color: #fff; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
          ...
          <div class="header-actions d-flex align-items-center justify-content-end">
            ...
            <div class="dropdown account-dropdown">
              <button class="header-action-btn" data-bs-toggle="dropdown">
                ...
                <span class="action-text d-none d-md-inline-block">Akun</span>
              </button>
              <div class="dropdown-menu">
                <div class="dropdown-header">
                  <h6>Welcome to <span class="sitename">ApotekIbunda</span></h6>
                ...
                <div class="dropdown-footer">
                  <a href={{ route('loginuser') }} class="btn btn-primary w-100 mb-2">Log In</a>
    ...
    <!-- Announcement Bar -->
    <div class="announcement-bar py-0.5">
      <div class="container-fluid container-xl">
  ...
  <main class="main">
    ...
    <!-- Hero Section -->
    <section class="ecommerce-hero-2 hero section" id="hero" style="padding-top: 180px;">
      <div class="container">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide-sale">
              <div class="row align-items-center">
                <div class="col-lg-6 content-col" data-aos="fade-right" data-aos-delay="100">
                  <div class="slide-content">
                    <span class="slide-badge">Batas Waktu</span>
                    <h1>Diskon <span>Obat</span> Hingga 50%</h1>
              ...
              <div class="row align-items-center">
                <div class="col-lg-6 content-col" data-aos="fade-right" data-aos-delay="100">
                  <div class="slide-content">
                    ...
                    <h1>Obat <span>Premium</span> PROMAG</h1>
                ...
                <div class="col-lg-6 image-col" data-aos="fade-left" data-aos-delay="200">
                  <div class="featured-showcase">
                    <div class="featured-image">
                      <img src="assets/img/product/product-9.png" alt="Featured Product">
    ...
    <section id="kategori" class="product-list section">
          ...
          <div class="col-12">
            <div class="product-filters isotope-filters mb-5 d-flex justify-content-center" data-aos="fade-up">
              <ul class="d-flex flex-wrap gap-2 list-unstyled">
                ...
                <li data-filter=".filter-clothing">Obat</li>
                <li data-filter=".filter-accessories">Supplemen</li>
                <li data-filter=".filter-electronics">Alat Medis</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row gy-3 align-items-center">
          <div class="col-lg-6 col-md-12">
            <div class="copyright">
              <p>© <span>Copyright</span> <strong class="sitename">Apotek Ibunda</strong>. All Rights Reserved.</p>
            </div>
            <div class="credits mt-1">
              ...
              Designed by <a href="https://bootstrapmade.com/">Muhamad Bayu</a>
            </div>
          </div>
